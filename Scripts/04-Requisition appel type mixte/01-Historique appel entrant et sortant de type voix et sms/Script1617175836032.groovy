...
'Vérifier que Voix et SMS sont cochés'
...
'Vérifier que Appels sortants et Appels entrants sont cochés'
...
WebUI.verifyElementPresent(findTestObject('Nouvelle demande/Choix de l input/Popin err/Message d erreur numero existe deja'), 
    3)
...
WebUI.callTestCase(findTestCase('04-Requisition appel type mixte/00-Called Tests Case/Verification ajout requisition appel entrant et sortant de type voix et sms(CT appel)'), 
