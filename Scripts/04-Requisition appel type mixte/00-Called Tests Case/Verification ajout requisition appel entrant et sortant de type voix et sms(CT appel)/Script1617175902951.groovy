...
String ExpectedRequisitionA = ('Appels et SmsEntrants et Sortantsmsisdn (034' + GlobalVariable.msisdnATraiterA) + ')'

String ExpectedRequisitionB = ('Appels et SmsEntrants et Sortantsmsisdn (034' + GlobalVariable.msisdnATraiterB) + ')'
