...
String ExpectedRequisitionA = ('SMSSortantmsisdn (034' + GlobalVariable.msisdnATraiterA) + ')'

String ExpectedRequisitionB = ('SMSSortantmsisdn (034' + GlobalVariable.msisdnATraiterB) + ')'
