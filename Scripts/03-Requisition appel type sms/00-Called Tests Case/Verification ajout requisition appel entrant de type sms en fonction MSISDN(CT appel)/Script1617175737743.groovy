...
String ExpectedRequisitionA = ('SMSEntrantmsisdn (034' + GlobalVariable.msisdnATraiterA) + ')'

String ExpectedRequisitionB = ('SMSEntrantmsisdn (034' + GlobalVariable.msisdnATraiterB) + ')'
