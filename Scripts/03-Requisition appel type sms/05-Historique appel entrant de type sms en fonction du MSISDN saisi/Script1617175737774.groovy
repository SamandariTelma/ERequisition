...
WebUI.callTestCase(findTestCase('03-Requisition appel type sms/00-Called Tests Case/Verification ajout requisition appel entrant de type sms en fonction MSISDN(CT appel)'), 
