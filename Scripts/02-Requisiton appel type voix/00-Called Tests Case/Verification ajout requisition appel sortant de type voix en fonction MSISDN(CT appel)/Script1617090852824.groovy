...
String ExpectedRequisitionA = ('VoixSortantmsisdn (034' + GlobalVariable.msisdnATraiterA) + ')'

String ExpectedRequisitionB = ('VoixSortantmsisdn (034' + GlobalVariable.msisdnATraiterB) + ')'
