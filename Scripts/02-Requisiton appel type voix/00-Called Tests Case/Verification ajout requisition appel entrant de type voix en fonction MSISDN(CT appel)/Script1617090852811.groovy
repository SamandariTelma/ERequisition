...
String ExpectedRequisitionA = ('VoixEntrantmsisdn (034' + GlobalVariable.msisdnATraiterA) + ')'

String ExpectedRequisitionB = ('VoixEntrantmsisdn (034' + GlobalVariable.msisdnATraiterB) + ')'
