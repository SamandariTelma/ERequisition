...
WebUI.callTestCase(findTestCase('02-Requisiton appel type voix/00-Called Tests Case/Verification ajout requisition appel entrant de type voix en fonction IMEI(CT appel) (à enlever)'), 
