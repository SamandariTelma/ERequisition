...
String loginNouvelUsr = 'userTest'

String nomNouvelUsr = 'nameUserTest'
...
WebUI.verifyElementText(findTestObject('Administration utilisateur/Popin confirm/Titre popin confirmation ajout'), 'Confirmer l\'ajout du nouvel utilisateur '+loginNouvelUsr+' ?')
